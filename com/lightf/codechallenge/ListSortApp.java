...
/**
 * ListSortApp application performs sorting on integer arrays as follows:
 * 1. sorts an array, either ascending or descending based on a flag
 * 2. counts the number of unique values contained in an array
 * 3. prints each element of an array and a count of its occurrence
 *
 * The application can run an auto-test of its sorting routines with 
 * its pre-set data or, can sort user-entered data.
 *
 * Usage:
 *     java ListSortApp     (for external use)
 *     java ListSortApp 1   (internal tests will run and display output)
 *     java ListSortApp 2   (user is prompted to enter data to test app)
 *     
 */
public class ListSortApp  {
	...
	try ( BufferedReader br = new BufferedReader(new InputStreamReader(System.in))) {
	    ...
	    //
	        ...
	        //
	        //nothiing was entered; this is the exit option, so exit
	        //
	        ...
	        //
	        // verify the first character of the entry is one of the valid options.  (A, B, C, D, E, F)
	        //
	        ...
	        //
	        // verify that, if any option other than F is selected, a list of numbers has been provided
	        //
